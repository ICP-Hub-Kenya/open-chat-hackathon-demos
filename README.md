...
N/B: Ensure to run the following to have the rust dependencies & necessary tools **(especially to those who encounter such issues on wsl)**.
```bash
...
```bash 
cargo build  # as you are inside the dice bot folder
